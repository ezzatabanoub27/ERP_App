...
public class NewAppDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        NewAppGlobalFeatureConfigurator.Configure();
        NewAppModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<NewAppDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<NewAppResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/NewApp");

            options.DefaultResourceType = typeof(NewAppResource);
        ...
        {
            options.MapCodeNamespace("NewApp", typeof(NewAppResource));
        });
    }
}
